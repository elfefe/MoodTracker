...
public class com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxy extends com.moodtracker.elfefe.moodtracker.dao.CommentRealm
    ...
    public static com.moodtracker.elfefe.moodtracker.dao.CommentRealm copyOrUpdate(Realm realm, com.moodtracker.elfefe.moodtracker.dao.CommentRealm object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
    ...
    public static com.moodtracker.elfefe.moodtracker.dao.CommentRealm copy(Realm realm, com.moodtracker.elfefe.moodtracker.dao.CommentRealm newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.moodtracker.elfefe.moodtracker.dao.CommentRealm realmObject = realm.createObjectInternal(com.moodtracker.elfefe.moodtracker.dao.CommentRealm.class, ((com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxyInterface realmObjectCopy = (com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxyInterface) realmObject;

        realmObjectCopy.realmSet$comment(realmObjectSource.realmGet$comment());
        realmObjectCopy.realmSet$feeling(realmObjectSource.realmGet$feeling());
        return realmObject;
    }
    ...
    static com.moodtracker.elfefe.moodtracker.dao.CommentRealm update(Realm realm, com.moodtracker.elfefe.moodtracker.dao.CommentRealm realmObject, com.moodtracker.elfefe.moodtracker.dao.CommentRealm newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        realmObjectTarget.realmSet$feeling(realmObjectSource.realmGet$feeling());
        return realmObject;
    }
