...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E obj, boolean update, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (clazz.equals(com.moodtracker.elfefe.moodtracker.dao.CommentRealm.class)) {
            com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxy.CommentRealmColumnInfo columnInfo = (com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxy.CommentRealmColumnInfo) realm.getSchema().getColumnInfo(com.moodtracker.elfefe.moodtracker.dao.CommentRealm.class);
            return clazz.cast(io.realm.com_moodtracker_elfefe_moodtracker_dao_CommentRealmRealmProxy.copyOrUpdate(realm, columnInfo, (com.moodtracker.elfefe.moodtracker.dao.CommentRealm) obj, update, cache, flags));
        }
        throw getMissingProxyClassException(clazz);
    }
